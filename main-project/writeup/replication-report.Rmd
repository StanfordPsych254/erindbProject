...
We ran a paired t-test on the comparison between question 1 (baseline) and question 2b (counterexample). In a pilot with `r replication.n` naive participants, we do not find evidence that people revise their causal beliefs about other aspects of a particular situation (t(`r comp1$parameter`)=`r comp1$statistic`, p=`r comp1$p.value`).
