...
The main hypothesis for this study was actually that there would be an interaction between interview type and task type in a 2 (control vs. episodic interview) x 2 (task: OAT vs. AUT) repeated measures ANOVA where the dependent measure is the number of categories of appropriate uses. That requires using another task, which I would rather not do (but I *could*). The authors also found that "participants generated more categories of appropriate uses when they received the specificity induction than when they received the control induction." I plan to replicate this effect.
